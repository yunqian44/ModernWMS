 ...
 */
 ...
 namespace ModernWMS.WMS.IServices
 {
     ...
     public interface IStockprocessService : IBaseService<StockprocessEntity>
     {
         ...
         /// <returns></returns>
         Task<(List<StockprocessViewModel> data, int totals)> PageAsync(PageSearch pageSearch, CurrentUser currentUser);
         /// <summary>
         /// Get all records
         /// </summary>
         /// <returns></returns>
         Task<List<StockprocessViewModel>> GetAllAsync(CurrentUser currentUser);
         /// <summary>
         /// Get a record by id
         /// </summary>
